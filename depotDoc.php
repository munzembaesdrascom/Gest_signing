...
if (empty($_SESSION['MatriAgent'])) {
    header('location: login.php?locality=depotDoc.php');
} else {
    ?>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <body class="toggle-sidebar">
                    ...
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown pe-3">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="logout.php">                                <i class="bi bi-box-arrow-right"></i>
            ...
            <aside id="sidebar" class="sidebar">
                ...
                <ul class="sidebar-nav" id="sidebar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="depotDoc.php">
                                        ...
                                        <div class="row mb-3" style="flex-flow: nowrap;">
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item"> Postnom candidat :<span class="card-title"
                                                            id="Postnom"></span></li>
                                                    <li class="list-group-item"> Prenom candidat : <span class="card-title"
                                                            id="Prenom"></span>
                                                    </li>
                                                    <li class="list-group-item"> E-mail candidat : <span class="card-title"
                                                            id="E-mail"></span></li>
                                                    <li class="list-group-item"> Telephone candidat : <span class="card-title"
                                                            id="Telephone"></span>
                                                    </li>
                                                ...
                                                <!-- `DateDepos`, `LieuEtablit`, `Mention`, `Pourcentage`, `NumCand`, `CodeDoc` -->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- Default List group -->
                                                <ul class="list-group">
                                                    <li class="list-group-item"> Établissement :
                                                        <span class="card-title" id="LieuEtablit"></span>
                                                    </li>

                                                    <li class="list-group-item"> Mention :
                                                        <span class="card-title" id="Mention"></span>
                                                    </li>
                                                    <li class="list-group-item"> Pourcentage :
                                                        <span class="card-title" id="Pourcentage"></span>
                                                    </li>
                                                    <li class="list-group-item"> Document :
                                                        <span class="card-title" id="CodeDoc"></span>
                                                    </li>
                                                </ul><!-- End Default List group -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="row mb-3">
                                                <div class="col-sm-10">
                                                    <input type="search" class="form-control" id="inputSearchDoc"
                                                        placeholder="Document">
                                                    <div class="list-group" id="dropdownDocument">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row mb-3">
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="Etablitinp"
                                        ...
                                        <div class="col-12">
                                            <div class="row mb-3">
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="Mentioninp"
                                                        placeholder="Mention">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row mb-3">
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="Pourcentageinp"
                    ...
                    $("#Printer").click(
                        function () {
                            let numcand = $('#Nom').data('id'),
                                CodeDoc = $('#CodeDoc').data('id'),
                                Pourcentage = $('#Pourcentage').html().split(' %')[0],
                                Mention = $('#Mention').html(),
                                LieuEtablit = $('#LieuEtablit').html();
                ...
                $(document).ready(function () {
                    ...
                    $(document).on('click', '.searchBu', function () {
                        if (action == "Candidat" || action == "Inscrit") {
                            ...
                            $('#CodeDoc').text($(this).text())
                            $('#CodeDoc').attr('data-id', $(this).data('id'))
                            $('#inputSearchDoc').val('')
                            ...
                            function (data, status) {
                                if (data != "not found") {
                                    ...
                                    for (let i = 0; i < results.length; i++) {
                                        ...
                                        if (action === "Doc") {
                                            buttonText = result.LibDoc;
                                        }
                                        /* `CodeDoc`, `LibDoc` */
                                        let button = buttonTemplate.clone(); // Clonez le modèle
                                        button.attr('data-id', result.NumCand || result.CodeDoc);
                    ...
                    $('#inputSearchDoc').on('input', function () {
                        action = "Doc";
                        queryId = '#inputSearchDoc'
                        Aff = '#dropdownDocument'
                    ...
                    Etablitinp*/
                    $('#Mentioninp').on('input', () => {
                        console.log($('#Mentioninp').val())
                        $('#Mention').html($('#Mentioninp').val())
                    });
                    $('#Pourcentageinp').on('input', () => {
                        $('#Pourcentage').html($('#Pourcentageinp').val() + " %")
                    });
                    $('#Etablitinp').on('input', () => {
                        console.log($('#Etablitinp').val())
                        $('#LieuEtablit').html($('#Etablitinp').val())
                    });
